...
public class CartService {
    ...
    @Transactional
    public CartResponse getCart(Long custimerId) throws ResourceNotFoundException {
        Cart cart = cartRepository.findById(custimerId)
                .orElseThrow(() -> new ResourceNotFoundException(
                        "Cart" + custimerId + " does not exist"));
