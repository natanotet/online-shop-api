...
import org.fasttrackit.onlineshopapi.steps.CustomersSteps;
...
public class CartServiceIntegrationTests {
    ...
    @Test
    public void testAddToCart_whenValidRequest_theCreateCart() throws ResourceNotFoundException {

        Customer customer = customersSteps.createCustomer();
        ...
        ProductResponse firsProduct = cart.getProducts().iterator().next();

        assertThat(firsProduct, notNullValue());
        assertThat(firsProduct.getName(), is(product.getName()));
